...
class XSUAAService {
    ...
    constructor(credentials) {
        // Accept credentials from caller (OAuth proxy resolves the correct
        // binding when multiple auth services are bound). Fall back to
        // cds.env.requires.auth for backwards compatibility.
