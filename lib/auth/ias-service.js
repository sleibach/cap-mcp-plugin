...
class IASService {
     ...
     * 
     * Note: For confidential clients, IAS requires BOTH:
     * - client_secret in form body
     * - Authorization: Basic header
     * This matches the behavior of @sap/approuter
     */
    async exchangeCodeForToken(code, redirectUri, code_verifier) {
        try {
            ...
            if (this.isConfidentialClient()) {
                // Add client_secret to form params
                tokenOptions.client_secret = this.credentials?.clientsecret;
                // Also add Basic Authorization header
