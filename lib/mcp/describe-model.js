...
function registerDescribeModelTool(server) {
    ...
    server.registerTool("cap_describe_model", {
        ...
        const describeEntity = (service, entity) => {
            ...
            const listName = (0, entity_tools_1.toolNameFor)({ serviceName: svcPart, target: entName, mcpName }, "query");
            const getName = (0, entity_tools_1.toolNameFor)({ serviceName: svcPart, target: entName, mcpName }, "get");
            return {
                service,
                entity: ent.name,
                keys,
