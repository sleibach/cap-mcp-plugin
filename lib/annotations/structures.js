...
class McpResourceAnnotation extends McpAnnotation {
    ...
    _omittedFields;
    /** Per-entity expand override: 'compositions' | 'none' | 'all' | undefined */
    _expandMode;
    /** Map of navigation property name -> { kind: 'Composition' | 'Association', target: string } */
    _navigations;
    /**
     ...
     */
    constructor(name, description, target, serviceName, functionalities, properties, resourceKeys, foreignKeys, wrap, restrictions, computedFields, propertyHints, omittedFields, expandMode, navigations) {
        ...
        this._navigations = navigations ?? new Map();
    }
    /**
    ...
    /**
     * Per-entity expand override. Undefined falls back to the runtime default.
     */
    get expandMode() {
        return this._expandMode;
    }
    /**
     * Map of navigation-property name → { kind, target }. Used by the expand
     * parser to validate which nav props are allowed and by the default-mode
     * resolver to pick compositions vs. associations.
     */
    get navigations() {
...
class McpToolAnnotation extends McpAnnotation {
    ...
    _elicits;
    /** Set of parameter names that are optional (not @mandatory / notNull / key) */
    _optionalParams;
    /**
     ...
     * @param optionalParams - Optional set of parameter names that are optional
     */
    constructor(name, description, operation, serviceName, parameters, entityKey, operationKind, keyTypeMap, restrictions, elicits, propertyHints, optionalParams) {
        ...
        this._optionalParams = optionalParams ?? new Set();
    }
    /**
     * Gets the set of optional parameter names
     * @returns Set of optional parameter names
     */
    get optionalParams() {
